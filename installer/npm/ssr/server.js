...
if (isProduction) {
    ...
    const bundle = require(path.json(buildPath, '/js/vue-ssr-server-bundle.json'))
    const clientManifest = require(path.json(buildPath, '/js/vue-ssr-client-manifest.json'));
